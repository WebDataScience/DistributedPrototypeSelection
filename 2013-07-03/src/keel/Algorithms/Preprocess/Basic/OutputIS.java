...
public class OutputIS {
	 ...
	 * @param relation Name of the data set
  	 * @throws IOException 
	 */
	public static void escribeSalida (String nombreFichero, double realIN[][], int nominalIN[][], boolean nulosIN[][], int instanciasOUT[], Attribute entradas[], Attribute salida, int nEntradas, String relation) throws IOException {
		 ...
		 // Fichero.escribeFichero (nombreFichero, cadena);
		  ...
		  Configuration conf = new Configuration();
			 ...
			 conf.set("fs.default.name","hdfs://turris/");
			 
			 conf.set("mapred.job.tracker", "turris:9000");
			...
			conf.addResource("/opt/hadoop/conf/core-site.xml");
			 conf.addResource("/opt/hadoop/conf/hdfs-site.xml");
			 
			 Path path = new Path(nombreFichero);
