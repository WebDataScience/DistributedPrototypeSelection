...
public class logistic_regression_only_test {
...
public static void make_vectors (String col_att, String test, String target_variable) throws IOException {
...
//URI path = URI.create("file:/tmp/vec.seq");
 ...
 hadoop_conf.set("fs.defaultFS","hdfs://turris/");
      ...
      */
      ...
      writer_test_name = SequenceFile.createWriter(fs, hadoop_conf,new Path(path3), 
				...
				*/
				...
				make_vectors(args[0],args[1],args[2]);
				...
				learningAlgorithm = ModelSerializer.readBinary(new FileInputStream(args[3]), OnlineLogisticRegression.class);
